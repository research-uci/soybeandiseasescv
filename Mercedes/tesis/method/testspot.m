...
%este es de prueba para manchas y su impresion correcta
addpath 'C:\Program Files\MATLAB\R2017a\funciones\natsortfiles';
impresionrgb='D:\resultado\r_param\4_resultado_mancha_rgb\';
impresionmul='D:\resultado\r_param\6_result\';

filesrgbcrop=dir([impresionrgb,'*.jpg']);
filesbincrop=dir([impresionmul,'*.jpg']);

encabezado = {'Name','Area','Perimetro','Excentricidad','AreaFF','MajorAxisLength','MinorAxisLength','Centroid 1','Centroid 2'};
archivo = 'D:\resultado\r_param\caracteristicas2.xlsx'; % ruta y nombre del archivo
