...
propiedades= regionprops(ListadoObjetos,'Perimeter','BoundingBox');
...
%tamanoMaximoManchas=1743.0;
%tamanoMaximoPerimetro=1743.0;
%tamanoMaximoPerimetro=1500.0;
tamanoMaximoPerimetro=1000.0;
seleccion=find([propiedades.Perimeter]<tamanoMaximoPerimetro);
...
SE = strel('disk', 2); %
BW4 = imdilate(IManchasB2,SE);

SE = strel('disk', 10); %1 FUNCIONA MUY BIEN 2 es bueno
IManchasB3 = imclose(BW4,SE);% exagerando la máscara me permite tomar mas region del defecto
