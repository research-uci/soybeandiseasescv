...
%function [] = BRemovalLAB(imagenInicialRGB, imagenNombreFR, nombreImagenF, tamanoObjeto, canalLMin, canalLMax, canalAMin, canalAMax, canalBMin, canalBMax, xmin,ymin,width,height)
% ########################################################################
...
%Temporal
%imwrite(mascaraRGBImagen,nombreImagenF,'jpg');
%imwrite(BW,nombreImagenF,'jpg');
end
