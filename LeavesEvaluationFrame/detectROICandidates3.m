function [ ] = detectROICandidates3( pathPrincipal, numROI, nombreImagenRemovida, imagenNombreFR, imagenNombreROI, imagenSalida,nombreSalidaBin,archivoVectorDef, nombreImagenOriginal)
% ########################################################################
...
etiqueta='CANDIDATO';
HOME=strcat(pwd,'/');
pathResultados=strcat(HOME,'SoyResults2/LeavesEvaluation/','output/'); %
...
pathTraining=strcat(HOME,'SoyResults2/LeavesEvaluation/trainingDB/'); %
...
IFRB2=im2bw(IFR,umbral); %Imagen tratada
...
nombreArchivoTraining='BDENFERMEDADES.csv';
...
%    fprintf('%10i, %10.4f, %10.4f, %10.4f, %10.4f, \n',  sumaArea, perimetro, excentricidad, ejeMayor, ejeMenor);    
    ...
    %
    objetoComparar = arrayTest(1,1:6) %objeto a comparar
    ...
    switch char(clasificacionObjeto(1))
        ...
        case 'HOJA'
            ...
            %% pintar máscara en blanco y negro
            IFRB2(coordenadasAPintar(2):coordenadasAPintar(2)+coordenadasAPintar(4)-1,coordenadasAPintar(1):coordenadasAPintar(1)+coordenadasAPintar(3)-1)=0;
            %% pintar hoja de color para mostrar
...
%% GUARDAR LA SILUETA BINARIA DE LO ENCONTRADO
imwrite( IFRB2, nombreSalidaBin, 'jpg'); %//guardar silueta binaria
